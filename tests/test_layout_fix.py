...
def test_layout_functionality():
    ...
    mock_graph_data = {
        ...
        "metadata": {"total_nodes": 4, "total_edges": 3, "duration": 0.1},
    }
    ...
    try:
        ...
        checks = [
            ...
            (
                "Layout options",
                'value="circular"' in html_content
                and 'value="timeline"' in html_content,
            ),
            ("Circular layout code", "radius = 300" in html_content),
            (
                "Timeline layout code",
                "timeline layout sorted by execution time" in html_content,
            ),
            ...
            (
                "Responsive spacing",
                "Math.max(150, (window.innerWidth - 200)" in html_content,
            ),
        ]
