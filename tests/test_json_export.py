...
def test_json_export_html():
    ...
    mock_graph_data = {
        ...
        "metadata": {"total_nodes": 2, "total_edges": 1, "duration": 0.1},
    }

    # Mock profiling stats
    mock_profiling_stats = {
        "memory": {"current_mb": 10.5, "peak_mb": 15.2},
        "io_wait": 0.001,
        "cpu": {"profile_data": """125 function calls in 0.002 seconds
    ...
    try:
        ...
        checks = [
            ...
            (
                ...
                "window.exportToJson = function()" in html_content,
            ),
