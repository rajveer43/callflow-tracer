...
echo    Done: Export to HTML complete
echo.
...
echo    Done: Export to 3D complete
echo.

REM Create a second trace for comparison
echo 16. Creating second trace for comparison...
callflow-tracer trace cli_demo.py --format json -o cli_test_output/trace2.json
echo    Done: Second trace complete
echo.

echo 17. Testing compare command...
callflow-tracer compare cli_test_output/trace.json cli_test_output/trace2.json -o cli_test_output/comparison.html --label1 "First Run" --label2 "Second Run" --no-browser
