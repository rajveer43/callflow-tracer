...
from ..core.tracer import trace_scope, get_current_graph, clear_trace
...
def callflow_trace(line):
    ...
    if graph is None:
        print(
            "No call graph data captured. Make sure to use @trace decorator or trace_scope context manager."
        )
        return
